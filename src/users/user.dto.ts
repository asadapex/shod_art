...
export class CreateUserDto {
  ...
  @ApiProperty({ description: 'Может ли редактировать продукты', example: true })
  @IsBoolean()
...
export class UpdateUserDto {
  @ApiProperty({ description: 'Логин пользователя', example: 'admin', required: false })
  @IsString()
  @IsOptional()
  login?: string;

  @ApiProperty({ description: 'Пароль пользователя', example: 'newpassword123', required: false })
  @IsString()
  @IsOptional()
  password?: string;
  ...
  @ApiProperty({ description: 'Может ли редактировать продукты', example: true, required: false })
  @IsBoolean()
  @IsOptional()
  canEditProducts?: boolean;

  @ApiProperty({ description: 'Может ли управлять логистикой', example: true, required: false })
  @IsBoolean()
  @IsOptional()
  canManageLogistics?: boolean;
}
